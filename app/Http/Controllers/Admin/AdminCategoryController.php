...
class AdminCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        */
        ...
        return redirect()->route('admin.category.index')->with('datos','Registro creado exitosamente..!!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.category.index')->with('datos','Registro eliminado..!!');
    }
}
