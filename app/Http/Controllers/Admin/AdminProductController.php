...
class AdminProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.product.index')->with('datos','Registro creado exitosamente..!!');
        //return $request->all();
    ...
    public function destroy($id)
    {
        ...
        // return $prod;
        $prod->delete();
        return redirect()->route('admin.product.index')->with('datos','Registro eliminado..!!');
    }
