    ...
    <form action="{{ route('admin.category.update',$cat->id) }}" method="POST">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Administracion de Categorías</h3>
        ...
        <div class="card-body">
          ...
          <div class="card-footer">
            ...
            <a class="btn btn-warning" href="{{ route('cancelar','admin.category.index')}}">Cancelar</a>
            
              <input
              :disabled = "deshabilitar_boton==1"
              type="submit" value="Guardar" class="btn btn-success float-right">
          </div>
          <!-- /.card-footer-->
      </div>
      <!-- /.card -->
