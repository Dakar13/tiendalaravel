              ...
              @foreach ($productos as $producto)
                <tr>
                    ...
                    <td> <a class="btn btn-default" 
                        href="{{ route('admin.product.show',$producto->slug)}}" ><i class="fas fa-binoculars"></i></a></td>
                    
                    <td> <a class="btn btn-info" 
                        href="{{ route('admin.product.edit',$producto->slug)}}" ><i class="far fa-edit"></i></a></td>
                    
                    <td> <a class="btn btn-danger" 
                        href="{{ route('admin.product.index')}}" 
                        {{-- data-toggle="modal" data-target="#modal_eliminar"  --}}
                        v-on:click.prevent="deseas_eliminar({{$producto->id}})"
                        ><i class="fas fa-backspace"></i></a></td>
